...
function(PL10_LowPower_LAB4_default_default_XC32_assemble_rule target)
    set(options
        "-g"
        "${ASSEMBLER_PRE}"
...
function(PL10_LowPower_LAB4_default_default_XC32_assembleWithPreprocess_rule target)
    set(options
        "-x"
        "assembler-with-cpp"
        "-g"
...
function(PL10_LowPower_LAB4_default_default_XC32_compile_rule target)
    set(options
        "-g"
        "${CC_PRE}"
        "-x"
...
function(PL10_LowPower_LAB4_default_default_XC32_compile_cpp_rule target)
    set(options
        "-g"
        "${CC_PRE}"
        "${DEBUGGER_NAME_AS_MACRO}"
...
function(PL10_LowPower_LAB4_default_link_rule target)
    set(options
        "-g"
        "${MP_EXTRA_LD_PRE}"
...
function(PL10_LowPower_LAB4_default_bin2hex_rule target)
    add_custom_target(
        PL10_LowPower_LAB4_default_Bin2Hex ALL
        COMMAND ${MP_BIN2HEX} ${PL10_LowPower_LAB4_default_image_name}
        WORKING_DIRECTORY ${PL10_LowPower_LAB4_default_output_dir}
        BYPRODUCTS "${PL10_LowPower_LAB4_default_output_dir}/${PL10_LowPower_LAB4_default_image_base_name}.hex"
        COMMENT "Convert build file to .hex")
    add_dependencies(PL10_LowPower_LAB4_default_Bin2Hex ${target})
endfunction()
